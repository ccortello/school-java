...
public class TreeDemo {
    public static void main(String[] args) {
        ...
        // On a CADE machine, use the following command to convert expressionTree.dot to a gif

        // First change directory to your project directory, where expressionTree.dot resides, then run:
