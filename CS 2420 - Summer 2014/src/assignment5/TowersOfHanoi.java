...
public class TowersOfHanoi {
    ...
    /**
     * The main method first displays the initial state of the towers and then solves its and at last displays the final
     * state of the towers. The method is set to be invoked from the command line with 1 or 2 arguments. The first
     * argument is necessary and it is the number of the discs to be solved and the second argument "-v" is optional to
     * print the state of the towers after each move.
     */
