...
//        DFStimer();
    ...
    void BFStimer() {
        ...
        int[] sizes = new int[]{1, 5, 10, 20, 50, 100, 200, 500, 1000};
        ...
        System.out.println("BFS, loops = " + timesToLoop + "\n\nsize\ttime\tavg");
    ...
    void DFStimer() {
        ...
        //print info for the max input size and the number of times looping, as well as column headers for results
        System.out.println("DFS, loops = " + timesToLoop + "\n\nsize\ttime\tavg");
...
//            BinarySearchTree<Integer> randListBST;
    ...
    void dijkstrasTimer() {
        ...
        //print info for the max input size and the number of times looping, as well as column headers for results
        System.out.println("dijkstras, loops = " + timesToLoop + "\n\nsize\ttime\tavg");
