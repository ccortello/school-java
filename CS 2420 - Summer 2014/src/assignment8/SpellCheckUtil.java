...
/**
 * Represents a "dictionary" of strings using a binary search tree and offers methods for spell-checking documents.
 *
 * @author Paymon Saebi
 */
public class SpellCheckUtil {
    ...
    public SpellCheckUtil() {
        dictionary = new ProbingHashTable(6000, new GoodHashFunctor());
    }
    ...
    public List<String> spellCheck(File documentFile) {
        ...
        // create ArrayList to hold the misspelled words to be returned.
    ...
    /**
     * Returns a list of the words contained in the specified file. (Note that symbols, digits, and spaces are
     * ignored.)
     *
