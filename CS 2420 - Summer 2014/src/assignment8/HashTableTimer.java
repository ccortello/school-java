...
//    static long seed = 82314917283974983L;
    ...
    public static void BadHashFunctionTime() throws IOException {
...
//        System.out.println("Timing trial for BadHashFunctor()\nHashes\tTotal time\tAverage Time");
        ...
        writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("BadHashFunctionTime.txt"), "utf-8"));

        // table sizes
        for (int i = 40000; i <= MAX_TABLE_SIZE; i += INTERVAL) {
            if (i == 0) i = 1000;
...
//            System.out.println(sizeData[i] + "\t" + totalTimeData[i]);
    ...
    public static void FairHashFunctionTime() throws IOException {
        long startTime, midTime, endTime;
        int dataIndex = 0;
        // stores values than prints at the end.
        int[] sizeData = new int[MAX_TABLE_SIZE / INTERVAL + 1];
...
//        System.out.println("Timing trial for BadHashFunctor()\nHashes\tTotal time\tAverage Time");
        BufferedWriter writer = null;
        writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("FairHashFunctionTime.txt"), "utf-8"));
...
//            System.out.println(sizeData[i] + "\t" + totalTimeData[i]);
    ...
    public static void GoodHashFunctionTime() throws IOException {
        long startTime, midTime, endTime;
        int dataIndex = 0;
        // stores values than prints at the end.
        int[] sizeData = new int[MAX_TABLE_SIZE / INTERVAL + 1];
...
//        System.out.println("Timing trial for BadHashFunctor()\nHashes\tTotal time\tAverage Time");
        BufferedWriter writer = null;
        writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("GoodHashFunctionTime.txt"), "utf-8"));
