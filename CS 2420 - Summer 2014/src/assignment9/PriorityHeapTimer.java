...
public class PriorityHeapTimer {
    ...
    static int TIMES_TO_LOOP = 10000;
    ...
    public static void PriorityHeapAddTimer() throws Exception {
        ...
        // table sizes
        for (int currentSize = 1000; currentSize <= MAX_SIZE; currentSize += INTERVAL) {
//			if (currentSize == 0) currentSize = 1000;

            // initiate variables for timing structures
            int combined = currentSize * TIMES_TO_LOOP; // represents the number of total operations which should be timed
