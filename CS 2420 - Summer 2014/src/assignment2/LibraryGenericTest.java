...
public class LibraryGenericTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Testing Library that uses name strings.......begin!");
        for (int i = 0; i < lib1.getInventoryList().size(); i++) {
            System.out.println(lib1.getInventoryList().get(i).toString());
        }
        ...
        System.out.println("Testing Library that uses (PhoneNumber).......begin!");
        for (int i = 0; i < lib2.getInventoryList().size(); i++) {
            System.out.println(lib2.getInventoryList().get(i).toString());
        }
        System.out.println("....................................end!");
